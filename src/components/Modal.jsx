...
const Modal = ({ updateDate, close, note, allStatesApp }) => {
  ...
  return (
    <div className="flex h-screen justify-center items-center fixed inset-0 z-50 border border-gray-200 rounded-md">
      <div
      ...
      >
        ...
        <div className=" p-4 pt-1">
          ...
          <input
            ...
            className="capitalize flex justify-center font-bold"
            type="text"
            value={titleEdit}
            onChange={(e) => {
          ...
          <div onClick={() => setModalOn(!modalOn)}>
            <button
              className="flex justify-center mx-auto font-bold"
              onClick={updateNote}
            >
              Update
            </button>
